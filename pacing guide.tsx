  ...
  const statesData: State[] = [
    ...
    },
    {
      ...
      standards: [
        ...
        { id: 'fl-4', code: 'SS.912.FL.1.5', title: 'Herd Mentality Effects', description: 'Evaluate how herd mentality affects personal financial decision-making', required: true },
        { id: 'fl-5', code: 'SS.912.FL.1.6', title: 'Anchoring in Financial Decisions', description: 'Describe how early information can provide an anchor that people use when making financial decisions', required: true },
        { id: 'fl-6', code: 'SS.912.FL.1.7', title: 'Confirmation Bias', description: 'Describe how people often focus on information that confirms their original beliefs when researching financial decisions', required: true },
        ...
        { id: 'fl-8', code: 'SS.912.FL.2.1', title: 'Career Choice Factors', description: 'Describe how people choose jobs or careers based on potential income and non-income factors', required: true },
        { id: 'fl-9', code: 'SS.912.FL.2.2', title: 'Education and Training Investment', description: 'Explain that people vary in their willingness to obtain more education or training', required: true },
        { id: 'fl-10', code: 'SS.912.FL.2.3', title: 'Informed Career Decisions', description: 'Analyze ways people can make more informed education, job, or career decisions by evaluating benefits and costs', required: true },
        { id: 'fl-11', code: 'SS.912.FL.2.6', title: 'Government Taxes and Services', description: 'Explain that taxes are paid to fund government goods and services as well as transfer payments', required: true },
        { id: 'fl-12', code: 'SS.912.FL.2.7', title: 'Investment Income Types', description: 'Explain how interest, dividends, and capital gains are forms of income earned from financial investments', required: true },
        { id: 'fl-13', code: 'SS.912.FL.2.8', title: 'Income and Tax Effects', description: 'Evaluate how sources of income, amount of income, and spending affect types and amounts of taxes paid', required: true },
        { id: 'fl-14', code: 'SS.912.FL.2.9', title: 'Entrepreneurship Career Choice', description: 'Describe why some people choose to become entrepreneurs as a career choice', required: true },
        { id: 'fl-15', code: 'SS.912.FL.2.10', title: 'Gig Economy Employment', description: 'Evaluate the benefits and costs of gig employment', required: true },
        { id: 'fl-16', code: 'SS.912.FL.2.11', title: 'Social Security System', description: 'Describe how Social Security is funded and the benefit it provides to retirees', required: true },
        { id: 'fl-17', code: 'SS.912.FL.2.12', title: 'Tax Forms and Calculations', description: 'Identify and complete appropriate tax forms to calculate the amount of federal income tax owed', required: true },
        { id: 'fl-18', code: 'SS.912.FL.2.13', title: 'Local Tax Types and Sources', description: 'Describe the types and sources of taxes at the local level', required: true },

        // STANDARD 3: BUYING GOODS AND SERVICES
        { id: 'fl-19', code: 'SS.912.FL.3.1', title: 'Consumer Decision-Making Factors', description: 'Analyze the factors that influence a consumer decision-making process', required: true },
        { id: 'fl-20', code: 'SS.912.FL.3.3', title: 'Product Features and Aspects', description: 'Discuss that when buying a good, consumers may consider various aspects and features of the product', required: true },
        { id: 'fl-21', code: 'SS.912.FL.3.4', title: 'Price Expression Influence', description: 'Describe ways that consumers may be influenced by how the price of a good is expressed', required: true },
        { id: 'fl-22', code: 'SS.912.FL.3.6', title: 'Charitable Giving', description: 'Explain that people may choose to donate money to charitable organizations because they gain satisfaction from donating', required: true },
        { id: 'fl-23', code: 'SS.912.FL.3.8', title: 'Payment Form Costs', description: 'Evaluate how different forms of payment can result in costs or fees', required: true },
        { id: 'fl-24', code: 'SS.912.FL.3.9', title: 'Budget Development', description: 'Develop a budget based on a given income and expenses for long-term and short-term financial goals', required: true },
        { id: 'fl-25', code: 'SS.912.FL.3.10', title: 'Contracts in Commerce', description: 'Understand that when individuals or business owners buy or sell goods or services, they may enter into contracts', required: true },
        { id: 'fl-26', code: 'SS.912.FL.3.11', title: 'Contract Terms and Conditions', description: 'Evaluate and interpret terms and conditions within a contract', required: true },
        { id: 'fl-27', code: 'SS.912.FL.3.12', title: 'Billing Statement Disputes', description: 'Understand the process of identifying and contesting an incorrect billing statement', required: true },

        // STANDARD 4: SAVING
        { id: 'fl-28', code: 'SS.912.FL.4.1', title: 'Banking Account Types', description: 'Describe the different types of accounts and financial products offered through banking institutions', required: true },
        { id: 'fl-29', code: 'SS.912.FL.4.2', title: 'Depository Institution Characteristics', description: 'Compare and contrast the characteristics of the various accounts and services offered by depository institutions', required: true },
        { id: 'fl-30', code: 'SS.912.FL.4.3', title: 'Account Fund Management', description: 'Explain how people should regularly track and manage funds in their account to ensure enough funds are available', required: true },
        { id: 'fl-31', code: 'SS.912.FL.4.4', title: 'Spending vs. Saving Impact', description: 'Analyze the impact of spending versus saving', required: true },
        { id: 'fl-32', code: 'SS.912.FL.4.5', title: 'Inflation and Money Value', description: 'Describe how inflation reduces the value of money', required: true },
        { id: 'fl-33', code: 'SS.912.FL.4.8', title: 'Financial Institution Regulation', description: 'Explain ways that government agencies supervise and regulate financial institutions', required: true },

        // STANDARD 5: USING CREDIT
        { id: 'fl-34', code: 'SS.912.FL.5.1', title: 'Credit Cost Comparison', description: 'Analyze the ways that consumers can compare the cost of credit using APR, initial fees, and late payment fees', required: true },
        { id: 'fl-35', code: 'SS.912.FL.5.2', title: 'Low Introductory Credit Rates', description: 'Explain why banks and financial institutions sometimes compete by offering credit at low introductory rates', required: true },
        { id: 'fl-36', code: 'SS.912.FL.5.3', title: 'Secured vs. Unsecured Loans', description: 'Explain that loans can be unsecured or secured with collateral', required: true },
        { id: 'fl-37', code: 'SS.912.FL.5.4', title: 'Borrowing Cost Factors', description: 'Describe the factors that influence the cost of borrowing from the perspective of the buyer and seller', required: true },
        { id: 'fl-38', code: 'SS.912.FL.5.5', title: 'Credit Decisions and Payment History', description: 'Explain that lenders make credit decisions based in part on consumer payment history', required: true },
        { id: 'fl-39', code: 'SS.912.FL.5.6', title: 'Loan Application Process', description: 'Demonstrate an understanding of completing a loan application', required: true },
        { id: 'fl-40', code: 'SS.912.FL.5.7', title: 'Credit Scores and Bureaus', description: 'Discuss that lenders can pay to receive a borrower credit score from a credit bureau', required: true },
        { id: 'fl-41', code: 'SS.912.FL.5.8', title: 'Credit Card Costs and Benefits', description: 'Analyze the costs and benefits associated with credit cards', required: true },
        { id: 'fl-42', code: 'SS.912.FL.5.9', title: 'Credit Report Uses', description: 'Describe that credit reports and scores may be requested by employers, property owners, and insurance companies', required: true },
        { id: 'fl-43', code: 'SS.912.FL.5.10', title: 'Loan Repayment Consequences', description: 'Examine the fact that failure to repay a loan has significant consequences for borrowers', required: true },
        { id: 'fl-44', code: 'SS.912.FL.5.11', title: 'Credit Counseling Services', description: 'Explain that consumers who have difficulty repaying debt can seek assistance through credit counseling services', required: true },
        { id: 'fl-45', code: 'SS.912.FL.5.12', title: 'Bankruptcy Option', description: 'Explain how bankruptcy may be an option for consumers who are unable to repay debt', required: true },
        { id: 'fl-46', code: 'SS.912.FL.5.13', title: 'Mortgage for Home Purchase', description: 'Explain that people often apply for a mortgage to purchase a home', required: true },
        { id: 'fl-47', code: 'SS.912.FL.5.14', title: 'Credit Protection Laws', description: 'Discuss that consumers who use credit should be aware of laws that are in place to protect them', required: true },
        { id: 'fl-48', code: 'SS.912.FL.5.15', title: 'Free Annual Credit Report', description: 'Explain that consumers are entitled to a free copy of their credit report annually', required: true },
        { id: 'fl-49', code: 'SS.912.FL.5.16', title: 'Postsecondary Education Financing', description: 'Analyze how postsecondary education can be financed through scholarships, grants, and other financial aid', required: true },
        { id: 'fl-50', code: 'SS.912.FL.5.17', title: 'Student Loan Types and Applications', description: 'Compare different types of student loans and understand how to complete a student loan application', required: true },

        // STANDARD 6: FINANCIAL INVESTING
        { id: 'fl-51', code: 'SS.912.FL.6.1', title: 'Investment Types and Purposes', description: 'Explain the purpose of various investments including stocks, bonds, mutual funds, ETFs, real estate, and others', required: true },
        { id: 'fl-52', code: 'SS.912.FL.6.3', title: 'Investment Expenses and Returns', description: 'Explain how the expenses of buying, selling, and holding financial assets decrease the rate of return from investment', required: true },
        { id: 'fl-53', code: 'SS.912.FL.6.5', title: 'Risk vs. Return Trade-off', description: 'Discuss the trade-off between risk and return in comparing financial investments', required: true },
        { id: 'fl-54', code: 'SS.912.FL.6.7', title: 'Investment Diversification', description: 'Describe how diversifying investments in different types of financial assets can lower investment risk', required: true },
        { id: 'fl-55', code: 'SS.912.FL.6.10', title: 'Risk Tolerance Factors', description: 'Explain that people vary in their willingness to take risks based on personality, income, time horizon, and family situation', required: true },
        { id: 'fl-56', code: 'SS.912.FL.6.11', title: 'Government Role in Investment Markets', description: 'Describe why an economic role for government may exist if individuals do not have complete information about investments', required: true },
        { id: 'fl-57', code: 'SS.912.FL.6.12', title: 'Financial Market Regulation', description: 'Compare the SEC, Federal Reserve, and other government agencies that regulate financial markets', required: true },
        { id: 'fl-58', code: 'SS.912.FL.6.13', title: 'Investment Account Types', description: 'Describe the purpose of various investment accounts including retirement accounts, education accounts, and taxable accounts', required: true },
        { id: 'fl-59', code: 'SS.912.FL.6.14', title: 'Digital Currency Motives', description: 'Evaluate the motives for using a digital currency', required: true },

        // STANDARD 7: PROTECTING AND INSURING
        { id: 'fl-60', code: 'SS.912.FL.7.1', title: 'Risk Acceptance and Insurance', description: 'Describe how individuals vary with respect to their willingness to accept risk and why most people pay small costs to avoid larger losses', required: true },
        { id: 'fl-61', code: 'SS.912.FL.7.2', title: 'Insurance Premium Pooling', description: 'Understand that insurance companies charge premiums to create a pool of money to pay for losses incurred by policyholders', required: true },
        { id: 'fl-62', code: 'SS.912.FL.7.4', title: 'Insurance Coverage Decisions', description: 'Describe why people choose different amounts of insurance coverage based on their risk willingness, occupation, lifestyle, age, and financial profile', required: true },
        { id: 'fl-63', code: 'SS.912.FL.7.5', title: 'Government and Insurance Requirements', description: 'Explain how governments and contractual obligations can influence decisions to obtain different forms of insurance', required: true },
        { id: 'fl-64', code: 'SS.912.FL.7.6', title: 'Moral Hazard in Insurance', description: 'Describe how an insurance contract can increase the probability or size of a potential loss', required: true }
      ],
      lessonMappings: [
